...
public class StudentDAOImplWithMYSQL implements StudentDAO {
	private static final String GENRATE_RESULT="INSERT INTO studentresult(sname,age,adress,total,result) VALUES(?,?,?,?,?)";
	private Connection con = null;

	// cons
	public StudentDAOImplWithMYSQL() throws Exception {
		// create connection
